...
/// <summary>
/// Unit tests for the BaseEntityWithCrudl class.
/// </summary>
[TestClass]
public class BaseEntityWithCrudlTests
{
    ...
    {
        // Arrange
        IBaseRepositoryWithCrudl<MockDto, int>? nullRepository = null;
        var logger = new MockLogger();
    ...
    public void Constructor_WithLoggerFactory_InitializesSuccessfully()
    {
        ...
        // Act
        var entity = new MockCrudlEntity(repository, loggerFactory);
    ...
    public void Constructor_WithLoggerFactoryAndNullRepository_ThrowsArgumentNullException()
    {
        ...
        try
        {
            var entity = new MockCrudlEntity(nullRepository!, loggerFactory);
        }
        catch (ArgumentNullException)
        {
            threwException = true;
