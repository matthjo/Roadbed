...
namespace Roadbed
{
    ...
    public static class CommonAssemblyExtension
    {
        ...
        /// </code>
        /// </remarks>
        public static string ReadTextResource(this Assembly assembly, string fileAndExtensionWithFullNamespace)
        {
            // Result Container
            string result = string.Empty;

            // Null Check
            if ((assembly == null) || string.IsNullOrEmpty(fileAndExtensionWithFullNamespace))
            {
                return result;
            }
